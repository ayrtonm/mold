...
mold: supported targets: elf32-i386 elf64-x86-64 elf32-littlearm elf64-littleaarch64 elf32-littleriscv elf32-bigriscv elf64-littleriscv elf64-bigriscv elf32-powerpc elf64-powerpc elf64-powerpc elf64-powerpcle elf64-s390 elf64-sparc elf32-m68k elf32-sh-linux elf64-alpha elf32-mips
mold: supported emulations: elf_i386 elf_x86_64 armelf_linux_eabi aarch64linux aarch64elf elf32lriscv elf32briscv elf64lriscv elf64briscv elf32ppc elf32ppclinux elf64ppc elf64lppc elf64_s390 elf64_sparc m68kelf shlelf_linux elf64alpha elf32ltsmip)";
...
std::vector<std::string> parse_nonpositional_args(Context<E> &ctx) {
  ...
  while (!args.empty()) {
    ...
    if (read_arg("o") || read_arg("output")) {
      ...
      } else if (arg == "elf32ltsmip") {
        ctx.arg.emulation = MIPS32LE::target_name;
      } else {
